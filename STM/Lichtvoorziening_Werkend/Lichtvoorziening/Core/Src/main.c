...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, RGB_Rood_Pin|RGB_Groen_Pin|RGB_Blauw_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RGB_Rood_Pin RGB_Groen_Pin RGB_Blauw_Pin */
  GPIO_InitStruct.Pin = RGB_Rood_Pin|RGB_Groen_Pin|RGB_Blauw_Pin;
