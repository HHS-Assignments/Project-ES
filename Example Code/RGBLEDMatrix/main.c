...
int main(void)
{
  ...
  void LedAan (){
	  if(HAL_GPIO_ReadPin(Knop_Input_GPIO_Port, Knop_Input_Pin) == GPIO_PIN_RESET){
		  HAL_GPIO_WritePin(GPIOA, Knop_Ouput_Pin, GPIO_PIN_SET);
	  }
	  else {
		  HAL_GPIO_WritePin(GPIOA, Knop_Ouput_Pin, GPIO_PIN_RESET);
	  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Knop_Ouput_Pin|RGB_Rood_Pin|RGB_Groen_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Knop_Ouput_Pin RGB_Rood_Pin RGB_Groen_Pin */
  GPIO_InitStruct.Pin = Knop_Ouput_Pin|RGB_Rood_Pin|RGB_Groen_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
